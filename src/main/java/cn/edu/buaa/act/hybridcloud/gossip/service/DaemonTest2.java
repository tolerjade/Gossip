...
public class DaemonTest2
{
    ...
    public static void main(String[] args) throws IOException, InterruptedException
    {
		...
		*/
		GossiperDescriptor.init(new GossipConfig("localhost:9002","localhost:9001,localhost:9002,localhost:9003", "localhost:9001", "Member02","localhost:8002",System.getProperty("user.dir")));
		//TODO
    	...
    	service.getGossiper().register(new IApplicationStateStarting(){
    		public void gossiperStarting(){
    	    	service.getGossiper().addLocalApplicationState(ApplicationState.LOAD, VersionedValue.VersionedValueFactory.instance.load(2.2));
    	    	service.getGossiper().addLocalApplicationState(ApplicationState.WEIGHT, VersionedValue.VersionedValueFactory.instance.weight(2));
