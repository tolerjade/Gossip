...
public class GossipConfig
{
	...
	public GossipConfig(String listen_address, String seeds, String master, String memberId,String listen_client,String mount_point) {
		this.listen_address = listen_address;
		this.seeds = seeds;
		this.master = master;
		this.memberId = memberId;
		this.listen_client = listen_client;
	...
	public GossipConfig(String cluster_name, Integer phi_convict_threshold,
			...
			String listen_address, String seeds, String master,
						String listen_client) {
	...
	public String getListen_client() {
		return listen_client;
	}

	public void setListen_client(String listen_client) {
		this.listen_client = listen_client;
	}
	...
	private String memberId = "My Cluster";
	...
	private Long rpc_timeout_in_ms = new Long(30000) ;  //参考cassandra配置默认值
	...
	private String master;  //the cluster's master
	private String listen_client;
