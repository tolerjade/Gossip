...
import cn.edu.buaa.act.hybridcloud.gossip.gms.VersionedValue.VersionedValueFactory;
...
public class DaemonTest5
{
    ...
    public static void main(String[] args) throws IOException
    {
		...
		*/
		GossiperDescriptor.init(new GossipConfig("localhost:9005","localhost:9001,localhost:9002","localhost:9001","Member05","localhost:8005",""));
		//TODO
